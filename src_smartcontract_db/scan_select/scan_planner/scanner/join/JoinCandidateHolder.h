...
public:
	...
	const AbstractJoinCandidate* getBestCandidate() const noexcept;

private:
	const AbstractJoinCandidate* getBestFromList(const ArrayList<AbstractJoinCandidate>* list) const noexcept;
