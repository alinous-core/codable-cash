...
const  int _CONST = 70;
  /** RegularExpression Id. */
const  int CONTINUE = 71;
  /** RegularExpression Id. */
const  int DO = 72;
  /** RegularExpression Id. */
const  int ELSE = 73;
  /** RegularExpression Id. */
const  int EXTENDS = 74;
  /** RegularExpression Id. */
const  int FINALLY = 75;
  /** RegularExpression Id. */
const  int FOR = 76;
  /** RegularExpression Id. */
const  int GOTO = 77;
...
const  int IF = 78;
  /** RegularExpression Id. */
const  int IMPLEMENTS = 79;
  /** RegularExpression Id. */
const  int INSTANCEOF = 80;
  /** RegularExpression Id. */
const  int NEW = 81;
  /** RegularExpression Id. */
const  int PRIVATE = 82;
  /** RegularExpression Id. */
const  int PROTECTED = 83;
  /** RegularExpression Id. */
const  int PUBLIC = 84;
  /** RegularExpression Id. */
const  int RETURN = 85;
...
const  int INSERT = 100;
  /** RegularExpression Id. */
const  int UPDATE = 101;
  /** RegularExpression Id. */
const  int DELETE = 102;
  /** RegularExpression Id. */
const  int INTO = 103;
  /** RegularExpression Id. */
const  int FROM = 104;
...
const  int OR = 106;
  /** RegularExpression Id. */
const  int SQLAND = 107;
  /** RegularExpression Id. */
const  int LIKE = 108;
  /** RegularExpression Id. */
const  int ESCAPE = 109;
  /** RegularExpression Id. */
const  int LEFT = 110;
  /** RegularExpression Id. */
const  int RIGHT = 111;
  /** RegularExpression Id. */
const  int NATURAL = 112;
  /** RegularExpression Id. */
const  int INNER = 113;
  /** RegularExpression Id. */
const  int OUTER = 114;
...
const  int SET = 118;
  /** RegularExpression Id. */
const  int VALUES = 119;
  /** RegularExpression Id. */
const  int GROUP = 120;
  /** RegularExpression Id. */
const  int BY = 121;
  /** RegularExpression Id. */
const  int HAVING = 122;
  /** RegularExpression Id. */
const  int ORDER = 123;
  /** RegularExpression Id. */
const  int ASC = 124;
...
const  int ON = 128;
  /** RegularExpression Id. */
const  int SQL_NOT = 129;
  /** RegularExpression Id. */
const  int AS = 130;
  /** RegularExpression Id. */
const  int DISTINCT = 131;
  /** RegularExpression Id. */
const  int SHARE = 132;
  /** RegularExpression Id. */
const  int NOWAIT = 133;
  /** RegularExpression Id. */
const  int OF = 134;
  /** RegularExpression Id. */
const  int IN = 135;
  /** RegularExpression Id. */
const  int BETWEEN = 136;
  /** RegularExpression Id. */
const  int IS = 137;
  /** RegularExpression Id. */
const  int BEGIN = 138;
  /** RegularExpression Id. */
const  int COMMIT = 139;
  /** RegularExpression Id. */
const  int ROLLBACK = 140;
  /** RegularExpression Id. */
const  int CREATE = 141;
  /** RegularExpression Id. */
const  int DROP = 142;
  /** RegularExpression Id. */
const  int ALTER = 143;
...
const  int TABLE = 144;
  /** RegularExpression Id. */
const  int SQL_DEFAULT = 145;
  /** RegularExpression Id. */
const  int ADD = 146;
  /** RegularExpression Id. */
const  int RENAME = 147;
  /** RegularExpression Id. */
const  int COLUMN = 148;
  /** RegularExpression Id. */
const  int TO = 149;
  /** RegularExpression Id. */
const  int PRIMARY = 150;
  /** RegularExpression Id. */
const  int KEY = 151;
  /** RegularExpression Id. */
const  int UNIQUE = 152;
  /** RegularExpression Id. */
const  int CHECK = 153;
  /** RegularExpression Id. */
const  int RETURNS = 154;
  /** RegularExpression Id. */
const  int SETOF = 155;
  /** RegularExpression Id. */
const  int LANGUAGE = 156;
  /** RegularExpression Id. */
const  int REPLACE = 157;
  /** RegularExpression Id. */
const  int INDEX = 158;
  /** RegularExpression Id. */
const  int USING = 159;
...
const  int ROW = 161;
  /** RegularExpression Id. */
const  int STATEMENT = 162;
  /** RegularExpression Id. */
const  int EXECUTE = 163;
  /** RegularExpression Id. */
const  int PROCEDURE = 164;
  /** RegularExpression Id. */
const  int EXISTS = 165;
  /** RegularExpression Id. */
const  int TRIGGER = 166;
  /** RegularExpression Id. */
const  int BEFORE = 167;
  /** RegularExpression Id. */
const  int AFTER = 168;
  /** RegularExpression Id. */
const  int FOREIGN = 169;
  /** RegularExpression Id. */
const  int REFERENCES = 170;
  /** RegularExpression Id. */
const  int ADJUST_WHERE = 171;
  /** RegularExpression Id. */
const  int ADJUST_SET = 172;
  /** RegularExpression Id. */
const  int BOOL = 173;
  /** RegularExpression Id. */
const  int _NULL = 174;
