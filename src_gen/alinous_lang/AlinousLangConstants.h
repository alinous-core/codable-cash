...
const  int RENAME = 148;
  /** RegularExpression Id. */
const  int COLUMN = 149;
  /** RegularExpression Id. */
const  int TO = 150;
  /** RegularExpression Id. */
const  int PRIMARY = 151;
  /** RegularExpression Id. */
const  int KEY = 152;
  /** RegularExpression Id. */
const  int UNIQUE = 153;
  /** RegularExpression Id. */
const  int CHECK = 154;
  /** RegularExpression Id. */
const  int RETURNS = 155;
  /** RegularExpression Id. */
const  int SETOF = 156;
  /** RegularExpression Id. */
const  int LANGUAGE = 157;
  /** RegularExpression Id. */
const  int REPLACE = 158;
  /** RegularExpression Id. */
const  int INDEX = 159;
  /** RegularExpression Id. */
const  int USING = 160;
...
const  int ROW = 162;
  /** RegularExpression Id. */
const  int STATEMENT = 163;
  /** RegularExpression Id. */
const  int EXECUTE = 164;
  /** RegularExpression Id. */
const  int PROCEDURE = 165;
  /** RegularExpression Id. */
const  int EXISTS = 166;
  /** RegularExpression Id. */
const  int TRIGGER = 167;
  /** RegularExpression Id. */
const  int BEFORE = 168;
  /** RegularExpression Id. */
const  int AFTER = 169;
  /** RegularExpression Id. */
const  int FOREIGN = 170;
  /** RegularExpression Id. */
const  int REFERENCES = 171;
  /** RegularExpression Id. */
const  int ADJUST_WHERE = 172;
  /** RegularExpression Id. */
const  int ADJUST_SET = 173;
  /** RegularExpression Id. */
const  int BOOL = 174;
  /** RegularExpression Id. */
const  int _NULL = 175;
