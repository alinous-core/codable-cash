...
const  int _CONST = 69;
  /** RegularExpression Id. */
const  int CONTINUE = 70;
  /** RegularExpression Id. */
const  int DO = 71;
  /** RegularExpression Id. */
const  int ELSE = 72;
  /** RegularExpression Id. */
const  int EXTENDS = 73;
  /** RegularExpression Id. */
const  int FINALLY = 74;
  /** RegularExpression Id. */
const  int FOR = 75;
  /** RegularExpression Id. */
const  int GOTO = 76;
...
const  int IF = 77;
  /** RegularExpression Id. */
const  int IMPLEMENTS = 78;
  /** RegularExpression Id. */
const  int INSTANCEOF = 79;
  /** RegularExpression Id. */
const  int NEW = 80;
  /** RegularExpression Id. */
const  int PRIVATE = 81;
  /** RegularExpression Id. */
const  int PROTECTED = 82;
  /** RegularExpression Id. */
const  int PUBLIC = 83;
  /** RegularExpression Id. */
const  int RETURN = 84;
...
const  int OR = 105;
  /** RegularExpression Id. */
const  int SQLAND = 106;
  /** RegularExpression Id. */
const  int LIKE = 107;
  /** RegularExpression Id. */
const  int ESCAPE = 108;
  /** RegularExpression Id. */
const  int LEFT = 109;
  /** RegularExpression Id. */
const  int RIGHT = 110;
  /** RegularExpression Id. */
const  int NATURAL = 111;
  /** RegularExpression Id. */
const  int INNER = 112;
  /** RegularExpression Id. */
const  int OUTER = 113;
...
const  int SET = 117;
  /** RegularExpression Id. */
const  int VALUES = 118;
  /** RegularExpression Id. */
const  int GROUP = 119;
  /** RegularExpression Id. */
const  int BY = 120;
  /** RegularExpression Id. */
const  int HAVING = 121;
  /** RegularExpression Id. */
const  int ORDER = 122;
  /** RegularExpression Id. */
const  int ASC = 123;
...
const  int ON = 127;
  /** RegularExpression Id. */
const  int SQL_NOT = 128;
  /** RegularExpression Id. */
const  int AS = 129;
  /** RegularExpression Id. */
const  int DISTINCT = 130;
  /** RegularExpression Id. */
const  int SHARE = 131;
  /** RegularExpression Id. */
const  int NOWAIT = 132;
  /** RegularExpression Id. */
const  int OF = 133;
  /** RegularExpression Id. */
const  int IN = 134;
  /** RegularExpression Id. */
const  int BETWEEN = 135;
  /** RegularExpression Id. */
const  int IS = 136;
  /** RegularExpression Id. */
const  int BEGIN = 137;
  /** RegularExpression Id. */
const  int COMMIT = 138;
  /** RegularExpression Id. */
const  int ROLLBACK = 139;
  /** RegularExpression Id. */
const  int CREATE = 140;
  /** RegularExpression Id. */
const  int DROP = 141;
  /** RegularExpression Id. */
const  int ALTER = 142;
...
const  int TABLE = 143;
  /** RegularExpression Id. */
const  int SQL_DEFAULT = 144;
  /** RegularExpression Id. */
const  int ADD = 145;
  /** RegularExpression Id. */
const  int RENAME = 146;
  /** RegularExpression Id. */
const  int COLUMN = 147;
  /** RegularExpression Id. */
const  int TO = 148;
  /** RegularExpression Id. */
const  int PRIMARY = 149;
  /** RegularExpression Id. */
const  int KEY = 150;
  /** RegularExpression Id. */
const  int UNIQUE = 151;
  /** RegularExpression Id. */
const  int CHECK = 152;
  /** RegularExpression Id. */
const  int RETURNS = 153;
  /** RegularExpression Id. */
const  int SETOF = 154;
  /** RegularExpression Id. */
const  int LANGUAGE = 155;
  /** RegularExpression Id. */
const  int REPLACE = 156;
  /** RegularExpression Id. */
const  int INDEX = 157;
  /** RegularExpression Id. */
const  int USING = 158;
...
const  int ROW = 160;
  /** RegularExpression Id. */
const  int STATEMENT = 161;
  /** RegularExpression Id. */
const  int EXECUTE = 162;
  /** RegularExpression Id. */
const  int PROCEDURE = 163;
  /** RegularExpression Id. */
const  int EXISTS = 164;
  /** RegularExpression Id. */
const  int TRIGGER = 165;
  /** RegularExpression Id. */
const  int BEFORE = 166;
  /** RegularExpression Id. */
const  int AFTER = 167;
  /** RegularExpression Id. */
const  int FOREIGN = 168;
  /** RegularExpression Id. */
const  int REFERENCES = 169;
  /** RegularExpression Id. */
const  int ADJUST_WHERE = 170;
  /** RegularExpression Id. */
const  int ADJUST_SET = 171;
  /** RegularExpression Id. */
const  int BOOL = 172;
  /** RegularExpression Id. */
const  int _NULL = 173;
  /** RegularExpression Id. */
const  int FUNCTION = 174;
  /** RegularExpression Id. */
const  int USE = 175;
  /** RegularExpression Id. */
